...
def screenide_loomine():
    return {0:{#korrus
        ...
        1:{#korrus
            ...
            5: [Põrand(0, 1280, 500, 720), Põrand(1213, 2280, 360, 500), Põrand(1252, 2280, -11, 283),Põrand(523, 570, 0, 391), Põrand(290, 327, 290, 360), Põrand(145, 290, 290, 327),Põrand(129, 145, 290, 500), Põrand(0, 1280, 0, 1), Põrand(1241, 1305, 283, 300)],
        ...
        2:{
            ...
            3: [Põrand(-968, 353, 500, 735), Põrand(696, 730, 201, 243), Põrand(490, 696, 219, 243),Põrand(475, 490, 115, 243), Põrand(353, 989, 400, 423), Põrand(353, 1326, 640, 720),Põrand(487, 1280, 500, 540), Põrand(431, 884, 317, 328), Põrand(884, 925, 115, 328),Põrand(317, 353, 93, 758), Põrand(1142, 1280, -14, 500), Põrand(353, 961, 93, 115),Põrand(187, 317, 360, 400), Põrand(187, 317, 198, 238), Põrand(0, 1144, -20, -1),Põrand(-18, 85, -13, 115), Põrand(1126, 1142, 223, 235)],
        ...
        3:{
            ...
            4: [Põrand(-980, 343, 500, 735), Põrand(1126, 1279, 125, 670), Põrand(266, 343, 125, 500),Põrand(948, 1025, 0, 175), Põrand(1279, 1308, 125, 670), Põrand(343, 1063, 300, 350),Põrand(343, 1279, 670, 729), Põrand(458, 1126, 500, 551), Põrand(458, 948, 125, 175),Põrand(0, 1280, -12, -1), Põrand(0, 13, 0, 362), Põrand(119, 266, 315, 360), Põrand(13, 160, 153, 198)],
            ...
            2: [Põrand(1125, 1344, 500, 801), Põrand(-73, 133, 500, 784), Põrand(566, 713, 180, 256), Põrand(203, 350, 462, 538), Põrand(350, 434, 0, 200), Põrand(820, 916, 325, 396), Põrand(555, 702, 500, 615), Põrand(0, 1280, -39, -1), Põrand(1259, 1323, 0, 385)],
            1: [Põrand(0,1329,500,735),Põrand(0,1280,-42,-1)],
            0: [Põrand(-23,1329,500,735),Põrand(0,36,-25,500),Põrand(0,1280,-42,-1)]
        },
        4:{
...
def vastaste_loomine():
    return {
        ...
        3:{
            0: [Boss(40, 500, 100, 100, 150, 80, 15)],
            2: [Lind(586, 483, 54, 40, 3, 2, 8, 400, 10, 300), Preester(30, 500, 92, 73, 4, 1, 3, 2, 0.5)],
            3: [Vampiir(195, 98, 56, 46, 15, 5, 15, 500, 0.1), Jälitaja(626, 500, 92, 73, 14, 4, 10), Vampiir(141, 333, 56, 46, 20, 5, 9, 300, 0.3), Vampiir(999,310, 56,46, 17, 5, 8, 200, 0.3)],
...
def itemite_loomine():
    return {
        ...
        1:{
            1:[Lift(800, 500, 100, 100, (20,20,20), "mdea"), NPC_arvut(100, 500, 100, 100, (200,200,200),None)],
            3:[Item(1200, 50, 20, 20, maailm.püksid, "Sa leidsid rõivaid!", (200,200,0))],
            6:[Item(1100, 450, 50, 50, maailm.railgun, "Sa leidsid relva!", (191,0,255))]
        },
        2:{
            1:[Lift(800, 500, 100, 100, (20,20,20), "mdea")],
            3:[Item(500, 200, 30, 30, maailm.kiiver, "Sa leidsid rõivaid!", (200,200,0))]
        },
        3:{
            1:[Lift(800, 500, 100, 100, (20,20,20), "mdea")],
            3:[Item(400, 500, 50, 50, maailm.lifti_kaart, "Sa leidsid magnetkaardi!", (200,200,0)), NPC_portaal(1055, 500, 100, 140, (0,0,255), "Sul on vaja kõiki riideid!", 50, 5), NPC_portaal(45, 150, 100, 150, (255,255,255), "Riieteta portaali minna ei saa", 1100, 365)],
            4:[Item(1050, 600, 40, 40, maailm.kasukas, "Sa leidsid rõivaid!", (200,200,0))]
        },
        4:{
            5:[Item(1000, 600, 30, 30, maailm.sau, "Sa leidsid relva!", (191,0,255))]
        }
    }
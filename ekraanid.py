...
def screenide_loomine():
    return {0:{#korrus
        ...
        1:{#korrus
            ...
            1:[Põrand(0,36,0,500),Põrand(584,638,-16,344),Põrand(959,1148,305,360),Põrand(638,840,258,313),Põrand(1005,1148,137,192),Põrand(713,878,52,107),Põrand(1148,1280,-7,360),Põrand(36,713,-27,0),Põrand(1021,1280,-27,-1),Põrand(-23,1300,500,735),Põrand(638,713,-7,107)],
        ...
        2:{
            5:[Põrand(-23,1300,500,735),Põrand(1233,1280,0,500),Põrand(810,1233,417,500),Põrand(1081,1233,168,251),Põrand(919,1233,334,417),Põrand(1009,1233,251,334),Põrand(1153,1233,85,168),Põrand(96,687,298,360),Põrand(371,405,0,298),Põrand(0,1058,0,1)],
            4:[Põrand(223,1546,501,736),Põrand(0,223,640,720),Põrand(-678,115,501,541),Põrand(96,1183,298,360),Põrand(0,1280,0,1),Põrand(-80,12,-13,501)],
            3:[Põrand(-968,355,500,735),Põrand(696,730,201,243),Põrand(565,696,219,243),Põrand(550,565,115,243),Põrand(353,989,400,423),Põrand(353,1280,640,720),Põrand(487,1280,500,540),Põrand(431,884,317,328),Põrand(884,925,115,328),Põrand(317,353,93,758),Põrand(1142,1280,-14,500),Põrand(353,961,93,115),Põrand(187,317,360,400),Põrand(187,317,198,238),Põrand(0,1144,-20,-1),Põrand(-18,85,-13,115)],
            2:[Põrand(0,133,501,784),Põrand(0,133,501,784),Põrand(205,352,322,398),Põrand(853,949,430,501),Põrand(1125,1335,500,801),Põrand(0,133,-167,116),Põrand(1125,1295,-184,116),Põrand(544,640,322,393)],
            1:[Põrand(1020,1147,665,719),Põrand(0,713,501,784),Põrand(1147,1280,501,784),Põrand(714,1003,501,534),Põrand(0,36,-19,501),Põrand(594,714,360,501),Põrand(172,363,233,273),Põrand(363,400,174,273),Põrand(36,154,326,370),Põrand(154,172,233,370),Põrand(4,1280,-33,-1),Põrand(1147,1280,-163,120)]},
        3:{

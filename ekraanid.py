...
def screenide_loomine():
    return {0:{#korrus
        ...
        2:{
            ...
            3:[Põrand(-968,353,500,735),Põrand(696,730,201,243),Põrand(490,696,219,243),Põrand(475,490,115,243),Põrand(353,989,400,423),Põrand(353,1326,640,720),Põrand(487,1280,500,540),Põrand(431,884,317,328),Põrand(884,925,115,328),Põrand(317,353,93,758),Põrand(1142,1280,-14,500),Põrand(353,961,93,115),Põrand(187,317,360,400),Põrand(187,317,198,238),Põrand(0,1144,-20,-1),Põrand(-18,85,-13,115)],
...
def itemite_loomine():
    return {
        0:{#korrus
            ...
            1:[NPC_info(394, 500, 162, 62, (200,200,200), [100, 50, 800, 300], ["Tere tulemast Deltasse!", "Liikumiseks vajuta  'A'  ja  'D'   või   '<-'  ja  '->'  klahve", "Hüppamiseks vajuta 'W' või 'Z' klahvi", "Tulistamiseks vajuta 'SPACE' või 'X' klahvi", "Vajuta 'P' ,et hinge tõmmata", "Vajuta 'ENTER' ,kui sa kellegagi räägid ", "---------------------", "Keegi on kohvikus (kohvik on paremat kätt -->)"])], #➡️
        ...
        2:{
            ...
            3:[Item(750, 240, 30, 30, maailm.kiiver, "Sa leidsid rõivaid!", (200,200,0))]
        },
        3:{
            #1:[Item(95, 450, 40, 40, maailm.ling, "", (255,255,0))],
            3:[NPC_portaal(1055, 500, 100, 140, (0,0,255), "Sul on vaja kõiki riideid!", 50, 5), NPC_portaal(45, 150, 100, 150, (255,255,255), "Riieteta portaali minna ei saa", 1100, 365)],
